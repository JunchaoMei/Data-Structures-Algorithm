class Edge
{
	...
	//constructor
	public Edge(int sp, int ep)
	{ startPoint=sp; endPoint=ep;}
	public Edge(int sp, int dist, int ep)
	{ startPoint=sp; distance=dist; endPoint=ep;}
...
class Dijkstra_2D_Array
{	//paths starting from vertex-k
	public static void dijkstra_2D_Array (int[][] W, Edge[] F, int k)
	{
		int n = W.length-1;
